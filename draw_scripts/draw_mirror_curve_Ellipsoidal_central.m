function draw_mirror_curve_Ellipsoidal_central(...
    A, B, C, ...
    c, s, q, ...
    plot_set ...
    )
...
c_xy1 = 2*k*q_1^2*s_2^2 + 2*k*q_2^2*s_1^2 + 2*k*q_2^2*s_3^2 + 2*k*q_3^2*s_2^2 + c_3^2*q_1^2*s_2^2 + c_3^2*q_2^2*s_1^2 - 4*k*q_1*q_2*s_1*s_2 - 4*k*q_2*q_3*s_2*s_3 - 2*c_3^2*q_1*q_2*s_1*s_2;
...
c_xy4 = 2*k*q_1^2*s_2^2 + 2*k*q_2^2*s_1^2 + 2*k*q_1^2*s_3^2 + 2*k*q_3^2*s_1^2 + c_3^2*q_1^2*s_2^2 + c_3^2*q_2^2*s_1^2 - 4*k*q_1*q_2*s_1*s_2 - 4*k*q_1*q_3*s_1*s_3 - 2*c_3^2*q_1*q_2*s_1*s_2;
c_xy5 = 2*c_3*k*q_1*q_2*s_1*s_3 - 2*c_3*k*q_1^2*s_2*s_3 - 2*c_3*k*q_2*q_3*s_1^2 + 2*c_3*k*q_1*q_3*s_1*s_2;
c_xy6 = 2*k^2*q_1*q_2*s_1*s_2 - k^2*q_2^2*s_1^2 - k^2*q_1^2*s_2^2;
