function draw_image_curve_Hyperboloidal_central( ... 
    A, B, C, c, H,...
    s, q, ...
...
c_uv2 = 2*q_1*q_2*s_3^2 + 2*q_3^2*s_1*s_2 - 2*q_1*q_3*s_2*s_3 - 2*q_2*q_3*s_1*s_3;
c_uv3 = 2*q_1*q_3*s_2^2 + 2*q_2^2*s_1*s_3 - 2*q_1*q_2*s_2*s_3 - 2*q_2*q_3*s_1*s_2 - 2*k*q_1*q_3*s_2^2 - 2*k*q_2^2*s_1*s_3 + 2*k*q_1*q_2*s_2*s_3 + 2*k*q_2*q_3*s_1*s_2;
...
c_uv5 = 2*q_2*q_3*s_1^2 + 2*q_1^2*s_2*s_3 - 2*q_1*q_2*s_1*s_3 - 2*q_1*q_3*s_1*s_2 - 2*k*q_2*q_3*s_1^2 - 2*k*q_1^2*s_2*s_3 + 2*k*q_1*q_2*s_1*s_3 + 2*k*q_1*q_3*s_1*s_2;
c_uv6 = 2*q_1*q_2*s_1*s_2 - q_2^2*s_1^2 - q_1^2*s_2^2;
